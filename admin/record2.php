...
<head>
	<title>06-03-2021 Fatema Mam Attendance List </title>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="container-fluid" style="margin-top:70px;">
		...
		<br />
		<div class="alert alert-info"><b> Business Communication Class Record </b></div>
		...
		<div class="well col-lg-12">
			<table id="table" class="table table-bordered">
				...
				<tbody>
					<?php
					$q_time = $conn->query("SELECT * FROM `time2`") or die(mysqli_error());
