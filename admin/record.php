...
<head>
	<title>06-03-2021 Humaira Mam Attendance List </title>
	<meta charset="utf-8" />
		...
		<ul class="nav nav-pills"><br>
         ...
         <h5>Date- 02-03-2021 </h5>
               Sub- Computer & Information Technology (2nd sem. Sec B)<br/>
                        ...
                        <center>--------------------------------------------------------------------------------------------</center> -->
			<!--    <center><h3>Attendance List </h3>
                     <h5>Date- 28-02-2021 </h5>
               Sub- Principles of Management (2nd sem. Sec B)<br/>
                          Host- Fatema Mam </h5></center>
                          <center>--------------------------------------------------------------------------------------------</center>  -->

			<!-- <center><h3>Attendance List </h3>
                     <h5>Date- 01-01-2021 </h5>
               Sub- Taxation in Bangladesh (2nd sem. Sec B)<br/>
                          Host- Nafisa Mam </h5></center>
                          <center>--------------------------------------------------------------------------------------------</center> -->

			<center>
				<h3>Attendance List </h3>
				<h5>Date- 31-08-2021 </h5>
				Sub- Introduction to Business of Banking (2nd sem. Sec B)<br />
				Host- Humaira Mam </h5>
			</center>
			<center>--------------------------------------------------------------------------------------------</center>
			...
			<br />
			<div class="alert alert-info"><b> Introduction to Business Class Record </b></div>
