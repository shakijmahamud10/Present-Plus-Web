...
<body class="alert-info">
	...
	<div class="container-fluid">
		...
		<div class="col-lg-6 well">
			...
			<center>
				<h5><b>Introduction to Business Attendance <span class="glyphicon glyphicon-ok-sign"></span></b></h5>
			</center>
			<li class="dropdown">
				<h4> <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-ok-sign"></span> Select Your Class <span class="caret"></span></a>
					<ul class="dropdown-menu">
						...
						<h4>
							<li><a href="index2.php"><span class="glyphicon glyphicon-education"></span> BC Attendance </a></li>
						</h4>
						<h4>
		...
		<center><small><a href="https://facebook.com/shakijmahamud10">Powered by Shakij Mahamud</a></small></center>
	</div>
	</div>
	</div>
</body>
